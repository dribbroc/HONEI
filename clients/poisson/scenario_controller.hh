                ...
                case 100:
                    {
                        ...
                        Multigrid<Tag_, Tag_, methods::NONE, methods::JAC, methods::CYCLE::V, methods::FIXED >::value(info.a[info.max_level], info.rhs[info.max_level], result, (unsigned long)11, std::numeric_limits<Prec_>::epsilon(), info);
...
#ifdef HONEI_SSE
                        Multigrid<tags::CPU::SSE, tags::CPU::SSE, methods::NONE, methods::JAC, methods::CYCLE::V, methods::MIXED>::value(A, RHS, result, (unsigned long)11, std::numeric_limits<double>::epsilon(), info);
#else
                        Multigrid<tags::CPU, tags::CPU, methods::NONE, methods::JAC, methods::CYCLE::V, methods::MIXED>::value(A, RHS, result, (unsigned long)11, std::numeric_limits<double>::epsilon(), info);
#endif
