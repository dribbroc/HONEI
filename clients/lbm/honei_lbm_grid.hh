...
#ifndef LBM_HONEI_LBM_GRID_HH
#define LBM_HONEI_LBM_GRID_HH

#include <scenario_controller_grid.hh>
#include <honei/util/time_stamp.hh>

ScenarioControllerGrid<tags::CPU, float> * controller_f;
ScenarioControllerGrid<tags::CPU, double> * controller_d;
