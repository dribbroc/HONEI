...
int main(int argc, char ** argv)
{
    ...
    unsigned long non_zeros(MatrixIO<io_formats::MTX>::get_non_zeros(input));
    ...
    MatrixIO<io_formats::MTX>::read_matrix(input, r, c, data);
    MatrixIO<io_formats::MTX>::get_sizes(input, rows, columns, ax, bx);
