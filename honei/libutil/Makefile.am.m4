...
include(`honei/libutil/files.m4')
...
libutil_includedir = $(includedir)/honei/libutil
libutil_include_HEADERS = general_headerlist $(GPUHEADERS) $(CELLHEADERS) $(HDF5HEADERS)
