...
namespace honei
{
    namespace cell
    {
        ...
        {
            void element_product_dense_dense_double(vector double * a, const vector double * b,
        ...
        {
            Operation<2, double, rtm_dma> element_product_dense_dense_double = {
                &implementation::element_product_dense_dense_double
            };
        }
    }
}
