...
namespace honei
{
    namespace cell
    {
        ...
        {
            void difference_dense_dense_double(vector double * a, const vector double * b,
        ...
        {
            Operation<2, double, rtm_dma> difference_dense_dense_double = {
                &implementation::difference_dense_dense_double
            };
        }
    }
}
