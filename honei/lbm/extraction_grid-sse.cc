...
void ExtractionGrid<tags::CPU::SSE, lbm_modes::DRY>::value(
        PackedGridInfo<D2Q9> & info, PackedGridData<D2Q9, DT_> & data, DT_ epsilon)
{
...
template void ExtractionGrid<tags::CPU::SSE, lbm_modes::DRY>::value<float>(
        PackedGridInfo<D2Q9> &, PackedGridData<D2Q9, float> &, float);

template void ExtractionGrid<tags::CPU::SSE, lbm_modes::DRY>::value<double>(
...
template void ExtractionGrid<tags::CPU::SSE, lbm_modes::WET>::value<float>(
        PackedGridInfo<D2Q9> &, PackedGridData<D2Q9, float> &, float);

template void ExtractionGrid<tags::CPU::SSE, lbm_modes::WET>::value<double>(
        PackedGridInfo<D2Q9> &, PackedGridData<D2Q9, double> &, double);
