...
EqDisGridLABSWETest<tags::OpenCL::Accelerator, float> ocl_acc_eq_dist_grid_test_float("float");
EqDisGridLABSWETest<tags::OpenCL::Accelerator, double> ocl_acc_eq_dist_grid_test_double("double");
#endif
#ifdef HONEI_CELL
