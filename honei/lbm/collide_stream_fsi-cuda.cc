...
namespace
{
    class cudaColStreamFSIGridfloat
    {
        private:
        ...
        public:
            cudaColStreamFSIGridfloat(PackedGridInfo<D2Q9> & info, PackedGridData<D2Q9, float> & data, PackedSolidData<lbm_lattice_types::D2Q9, float> & solids, float d_x, float d_y, unsigned long blocksize) :
                info(info),
                data(data),
                solids(solids),
                d_x(d_x),
