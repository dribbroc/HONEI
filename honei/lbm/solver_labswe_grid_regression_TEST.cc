            ...
            TaggedTest<Tag_>("solver_labswe_grid_regression_test<" + type + ">")
    {
        ...
        virtual void run() const
        {
            for (unsigned long scen(0) ; scen < ScenarioCollection::get_stable_scenario_count() ; ++scen)
            {
                ...
                SolverLABSWEGrid<Tag_, DataType_,lbm_force::CENTRED, lbm_source_schemes::BED_FULL, lbm_grid_types::RECTANGULAR, lbm_lattice_types::D2Q9, lbm_boundary_types::NOSLIP> solver(&data, &info, grid.d_x, grid.d_y, grid.d_t, grid.tau);
                ...
                SolverLABSWEGrid<tags::CPU, DataType_,lbm_force::CENTRED, lbm_source_schemes::BED_FULL, lbm_grid_types::RECTANGULAR, lbm_lattice_types::D2Q9, lbm_boundary_types::NOSLIP> solver_standard(&data_standard, &info_standard, grid_standard.d_x, grid_standard.d_y, grid_standard.d_t, grid_standard.tau);
