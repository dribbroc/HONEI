...
#endif
#ifdef HONEI_ITANIUM
SolverLABSWEGridRegressionTest<tags::CPU::Itanium, float> itanium_solver_test_float("float");
SolverLABSWEGridRegressionTest<tags::CPU::Itanium, double> itanium_solver_test_double("double");
#endif
#ifdef HONEI_CUDA
