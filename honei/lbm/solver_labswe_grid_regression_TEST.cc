    ...
    public TaggedTest<Tag_>
{
    public:
        ...
        virtual void run() const
        {
            ...
            SolverLABSWE<Tag_, DataType_,lbm_source_types::SIMPLE, lbm_source_schemes::BASIC, lbm_grid_types::RECTANGULAR, lbm_lattice_types::D2Q9, lbm_boundary_types::NOSLIP_PERIODIC> solver_standard(1.,1.,1., g_w_standard, g_h_standard, &h_standard, &b_standard, &u_standard, &v_standard);
            ...
            //Save vatrices to vectors, compute norm:
