...
namespace honei
{
    ...
    */
    ...
    template<>
        struct EquilibriumDistributionGrid<tags::CPU::Generic, lbm_applications::LABSWE>
        {
            /**
             * \name Equilibrium distribution.
             *
            ...
            template<typename DT1_, typename DT2_>
                static void value(DT2_ g, DT2_ e, PackedGridInfo<D2Q9> & info, PackedGridData<D2Q9, DT1_> & data)
                {
                    ...
                    const DT1_ * const tu(data.u->elements());
                    const DT1_ * const tv(data.v->elements());
                    const DT1_ * const th(data.h->elements());
                    const DT1_ * const distribution_x(data.distribution_x->elements());
                    const DT1_ * const distribution_y(data.distribution_y->elements());

                    DT1_ * f_eq_0(data.f_eq_0->elements());
                    DT1_ * f_eq_1(data.f_eq_1->elements());
                    DT1_ * f_eq_2(data.f_eq_2->elements());
                    DT1_ * f_eq_3(data.f_eq_3->elements());
                    DT1_ * f_eq_4(data.f_eq_4->elements());
                    DT1_ * f_eq_5(data.f_eq_5->elements());
                    DT1_ * f_eq_6(data.f_eq_6->elements());
                    DT1_ * f_eq_7(data.f_eq_7->elements());
                    DT1_ * f_eq_8(data.f_eq_8->elements());
