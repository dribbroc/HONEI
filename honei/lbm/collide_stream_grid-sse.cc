...
template void CollideStreamGrid<tags::CPU::SSE, lbm_boundary_types::NOSLIP, lbm_lattice_types::D2Q9>::value<float>(
        PackedGridInfo<D2Q9> &, PackedGridData<D2Q9, float> &, float tau);

template void CollideStreamGrid<tags::CPU::SSE, lbm_boundary_types::NOSLIP, lbm_lattice_types::D2Q9>::value<double>(
        PackedGridInfo<D2Q9> &, PackedGridData<D2Q9, double> &, double tau);
