...
void CollideStreamGrid<tags::CPU::Itanium, lbm_boundary_types::NOSLIP, lbm_lattice_types::D2Q9>::value(
        PackedGridInfo<lbm_lattice_types::D2Q9> & info,
        PackedGridData<lbm_lattice_types::D2Q9, DT1_> & data,
        DT1_ tau)
{
    CONTEXT("When performing collision and streaming (Itanium):");
...
template void CollideStreamGrid<tags::CPU::Itanium, lbm_boundary_types::NOSLIP, lbm_lattice_types::D2Q9>::value<float>(
        PackedGridInfo<lbm_lattice_types::D2Q9> &,
        PackedGridData<lbm_lattice_types::D2Q9, float> &,
        float tau);
template void CollideStreamGrid<tags::CPU::Itanium, lbm_boundary_types::NOSLIP, lbm_lattice_types::D2Q9>::value<double>(
        PackedGridInfo<lbm_lattice_types::D2Q9> &,
