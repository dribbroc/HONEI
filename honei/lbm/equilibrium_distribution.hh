                    ...
                    for(unsigned long i(0); i < h.rows(); ++i)
                    {
                        for(unsigned long j(0); j < h.columns(); ++j)
                        {
                            result(i,j) = ((g * h(i,j) * h(i,j)) /(DT1_(6.) * e * e)) +
                                          ...
                                          ((h(i,j) / (DT1_(2.) * e * e * e * e)) * (e_u * u(i,j) * e_u * u(i,j) + DT1_(2.) * e_u * u(i,j) * e_v * v(i,j) + e_v * v(i,j) * e_v * v(i,j))) -
                    ...
                    for(unsigned long i(0); i < h.rows(); ++i)
                    {
                        for(unsigned long j(0); j < h.columns(); ++j)
                        {
                            result(i,j) = ((g * h(i,j) * h(i,j)) /(DT1_(24.) * e * e)) +
                                          ...
                                          ((h(i,j) / (DT1_(8.) * e * e * e * e)) * (e_u * u(i,j) * e_u * u(i,j) + DT1_(2.) * e_u * u(i,j) * e_v * v(i,j) + e_v * v(i,j) * e_v * v(i,j))) -
