...
//---------------------
    template<typename Tag_, typename ResPrec_>
        class SolverLABSWE<Tag_, ResPrec_, lbm_source_types::SIMPLE, lbm_source_schemes::BASIC, lbm_grid_types::RECTANGULAR, lbm_lattice_types::D2Q9, lbm_boundary_types::NOSLIP_2>
        {
            private:
                /** Global variables.
                 *
                    ...
                    _time(0)
            {
                ...
                void solve()
                {
                    ...
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_0>::
                        value(*_temp_distribution_0,
                                *_distribution_0,
                                *_eq_distribution_0,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[0],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_1>::
                        value(*_temp_distribution_1,
                                *_distribution_1,
                                *_eq_distribution_1,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[1],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_2>::
                        value(*_temp_distribution_2,
                                *_distribution_2,
                                *_eq_distribution_2,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[2],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_3>::
                        value(*_temp_distribution_3,
                                *_distribution_3,
                                *_eq_distribution_3,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[3],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_4>::
                        value(*_temp_distribution_4,
                                *_distribution_4,
                                *_eq_distribution_4,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[4],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_5>::
                        value(*_temp_distribution_5,
                                *_distribution_5,
                                *_eq_distribution_5,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[5],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_6>::
                        value(*_temp_distribution_6,
                                *_distribution_6,
                                *_eq_distribution_6,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[6],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_7>::
                        value(*_temp_distribution_7,
                                *_distribution_7,
                                *_eq_distribution_7,
                                *_source_x, *_source_y,
                                ...
                                (*_distribution_vector_y)[7],
                                _relaxation_time);
                    CollideStream<Tag_, lbm_applications::LABSWE, lbm_boundary_types::NOSLIP_2, lbm_lattice_types::D2Q9::DIR_8>::
                        value(*_temp_distribution_8,
                                *_distribution_8,
                                *_eq_distribution_8,
                                *_source_x, *_source_y,
