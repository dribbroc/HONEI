...
EXTRA_DIST = Makefile.am.m4 files.m4 sample.nc
DEFS = \
	$(CELLDEF) \
	$(SSEDEF) \
	$(CUDADEF) \
...
libhoneilbm_la_SOURCES = filelist $(CELLFILES) $(SSEFILES) $(CUDAFILES)
...
Makefile.am : Makefile.am.m4 files.m4
	cd $(top_srcdir) ; ./misc/do_m4.bash honei/lbm/Makefile.am
