...
add(`equilibrium_distribution_grid',   `hh', `sse', `cuda', `cell', `itanium', `opencl', `test')
add(`equilibrium_distribution_grid_regression',  `test')
add(`extraction_grid',                 `hh', `sse', `cuda', `cell', `itanium', `opencl', `test')
...
add(`source',                          `hh', `test')
add(`tags',                            `hh')
add(`update_velocity_directions_grid', `hh', `sse', `cuda', `opencl', `cell')
