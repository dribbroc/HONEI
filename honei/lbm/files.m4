...
add(`collide_stream_grid',             `hh', `test')
add(`dc_advanced',                           `test')
add(`equilibrium_distribution',        `hh', `test')
add(`equilibrium_distribution_grid',   `hh', `test')
add(`extraction_grid',                 `hh')
add(`force_grid',                      `hh')
add(`grid',                            `hh')
...
add(`solver_labswe_grid',              `hh', `mc', `test')
...
add(`source',                          `hh', `test')
add(`tags',                            `hh')
add(`update_velocity_directions_grid', `hh')
