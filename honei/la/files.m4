...
add(`element_inverse',               `hh', `sse', `cell', `mc', `test')
add(`element_iterator',              `hh', `test')
add(`element_product',               `hh', `sse', `cell', `mc', `test')
add(`matrix',                        `hh')
add(`matrix_error',                  `hh', `cc')
add(`norm',                          `hh', `fwd', `sse', `cell')
add(`product',                       `hh', `sse', `cell', `mc', `test')
add(`reduction',                     `hh', `fwd', `sse', `cell', `test')
add(`residual',                      `hh', `test')
add(`scale',                         `hh', `sse', `cell', `mc', `test')
add(`scaled_sum',                    `hh', `sse', `cell', `mc', `test')
add(`sparse_matrix',                 `hh', `test')
add(`sparse_vector',                 `hh', `impl', `cc', `test')
add(`sum',                           `hh', `sse', `cell', `mc', `test')
add(`trace',                         `hh', `test')
add(`vector',                        `hh')
