...
namespace honei
{
    ...
    template <typename Tag_ = tags::CPU> struct Product
    {
        ...
        static inline BenchmarkInfo get_benchmark_info(const DenseVectorContinuousBase<DT_> & r, const MT_ & a, const DenseVectorContinuousBase<DT_> & /*b*/)
        {
            BenchmarkInfo result;
            result.flops = a.used_elements() * 2;
            result.load = (a.used_elements() * 3)* sizeof(DT_);
