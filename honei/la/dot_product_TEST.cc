...
DenseDotProductTest<tags::CPU::Generic, float> generic_dense_scalar_product_test_float("float");
DenseDotProductTest<tags::CPU::Generic, double> generic_dense_scalar_product_test_double("double");
DenseDotProductTest<tags::CPU::MultiCore::Generic, float> generic_mc_dense_scalar_product_test_float("MC float");
DenseDotProductTest<tags::CPU::MultiCore::Generic, double> generic_mc_dense_scalar_product_test_double("MC double");
#ifdef HONEI_SSE
...
DenseDotProductQuickTest<tags::CPU::Generic, float> generic_dense_scalar_product_quick_test_float("float");
DenseDotProductQuickTest<tags::CPU::Generic, double> generic_dense_scalar_product_quick_test_double("double");
DenseDotProductQuickTest<tags::CPU::MultiCore::Generic, float> generic_mc_dense_scalar_product_quick_test_float("MC float");
DenseDotProductQuickTest<tags::CPU::MultiCore::Generic, double> generic_mc_dense_scalar_product_quick_test_double("MC double");
#ifdef HONEI_SSE
...
DenseVectorRangeDotProductTest<tags::CPU::Generic, float> generic_dense_vector_range_scalar_product_test_float("float");
DenseVectorRangeDotProductTest<tags::CPU::Generic, double> generic_dense_vector_range_scalar_product_test_double("double");
DenseVectorRangeDotProductTest<tags::CPU::MultiCore::Generic, float> generic_mc_dense_vector_range_scalar_product_test_float("MC float");
DenseVectorRangeDotProductTest<tags::CPU::MultiCore::Generic, double> generic_mc_dense_vector_range_scalar_product_test_double("MC double");
#ifdef HONEI_SSE
...
DenseVectorRangeDotProductQuickTest<tags::CPU::Generic, float> generic_dense_vector_range_scalar_product_quick_test_float("float");
DenseVectorRangeDotProductQuickTest<tags::CPU::Generic, double> generic_dense_vector_range_scalar_product_quick_test_double("double");
DenseVectorRangeDotProductQuickTest<tags::CPU::MultiCore::Generic, float> generic_mc_dense_vector_range_scalar_product_quick_test_float("MC float");
DenseVectorRangeDotProductQuickTest<tags::CPU::MultiCore::Generic, double> generic_mc_dense_vector_range_scalar_product_quick_test_double("MC double");
#ifdef HONEI_SSE
