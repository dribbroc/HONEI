...
namespace honei
{
    namespace cell
    {
        enum OpCode
        {
            ...
            oc_product_dense_matrix_dense_vector_double,
            ...
            oc_norm_l_one_dense_double,
            oc_norm_l_two_dense_float,
            oc_norm_l_two_dense_double,
            ...
            oc_collide_stream_grid_float,
            oc_collide_stream_grid_times_float,
