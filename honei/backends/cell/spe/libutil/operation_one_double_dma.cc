...
namespace honei
{
    ...
    {
        template <>
        void operation<Operation<1, double, rtm_dma> >(const Operation<1, double, rtm_dma> & operation,
                const Instruction & instruction)
        {
            ...
            double scalar = instruction.d.d; // optional scalar value to be computed.
            ...
            while (counter > 1)
            {
                ...
                operation.calculate(a[current].vectorised, size / sizeof(vector double), scalar);
