...
namespace honei
{
    namespace cell
    {
        ...
        {
            void scaled_sum_dense_dense_float(vector float * a, const vector float * b,
        ...
        {
            Operation<2, float, rtm_dma> scaled_sum_dense_dense_float = {
                &implementation::scaled_sum_dense_dense_float
            };
        }
    }
}
