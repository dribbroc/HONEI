...
namespace honei
{
        ...
        public SPEInstruction
    {
        ...
        public:
             ...
             */
            SPEFrameworkInstruction(const OpCode opcode, DataType_ * a_elements, DataType_ * b_elements,
                    DataType_ * c_elements, DataType_ * d_elements, const unsigned size,
                    const DataType_ a_scalar = DataType_(0),
                    const DataType_ b_scalar = DataType_(0),
                    const DataType_ c_scalar = DataType_(0),
                    const DataType_ d_scalar = DataType_(0));
    ...
    extern template class SPEFrameworkInstruction<4, float, cell::rtm_dma>;
    extern template class SPEFrameworkInstruction<4, double, cell::rtm_dma>;
