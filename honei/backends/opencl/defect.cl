...
#ifdef __CPU__
__kernel void defect_smell_dv_f(__global float * rhs, __global float * x, __global float * y, __global unsigned long * Aj, __global float * Ax,
...
__kernel void defect_smell_dv_d(__global double * rhs, __global double * x, __global double * y, __global unsigned long * Aj, __global double * Ax,
                                              __global unsigned long * Arl, unsigned long num_rows, unsigned long stride, unsigned long threads,
