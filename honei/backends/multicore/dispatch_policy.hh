            ...
            public:
                ...
                Ticket<tags::CPU::MultiCore> operator() ()
                {
                    ...
                    if (core_id >= top->num_lpus() || (! top->lpu(core_id)->has_thread))
                        ...
                        core_id = top->lpu(core_id)->sched_id;
        ...
        class LinearSocketPolicy
        {
            ...
            public:
                ...
                Ticket<tags::CPU::MultiCore> operator() ()
                {
                    ...
                    {
                        LPU * lpu = Topology::instance()->lpu(0);
                        Ticket<tags::CPU::MultiCore> ticket(lpu->socket_id, lpu->sched_id);
#ifdef DEBUG
                    ...
                    Ticket<tags::CPU::MultiCore> ticket(lpu->linear_enqueue_succ->socket_id, lpu->linear_enqueue_succ->sched_id);
