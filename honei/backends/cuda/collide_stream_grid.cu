...
namespace honei
{
    ...
    template <typename DT_>
        void cuda_collide_stream_grid(unsigned long start, unsigned long end,
                ...
                unsigned long blocksize)
        {
            ...
            honei::cuda::collide_stream_grid_0_gpu<DT_><<<grid, block>>>(
                    f_eq_0_gpu,
                    f_0_gpu,
                    f_temp_0_gpu,
                    tau,
            ...
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_1_gpu, f_eq_1_gpu, f_1_gpu, f_temp_1_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_2_gpu, f_eq_2_gpu, f_2_gpu, f_temp_2_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_3_gpu, f_eq_3_gpu, f_3_gpu, f_temp_3_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_4_gpu, f_eq_4_gpu, f_4_gpu, f_temp_4_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_5_gpu, f_eq_5_gpu, f_5_gpu, f_temp_5_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_6_gpu, f_eq_6_gpu, f_6_gpu, f_temp_6_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_7_gpu, f_eq_7_gpu, f_7_gpu, f_temp_7_gpu, tau, size);
            honei::cuda::collide_stream_grid_n_gpu<DT_><<<grid, block>>>(dir_8_gpu, f_eq_8_gpu, f_8_gpu, f_temp_8_gpu, tau, size);
...
extern "C" void cuda_collide_stream_grid_float(unsigned long start, unsigned long end,
        ...
        unsigned long blocksize)
{
    honei::cuda_collide_stream_grid<float>(start, end,
...
extern "C" void cuda_collide_stream_grid_double(unsigned long start, unsigned long end,
        void * dir_1, void * dir_2, void * dir_3, void * dir_4,
        void * dir_5, void * dir_6, void * dir_7, void * dir_8,
        void * f_eq_0, void * f_eq_1, void * f_eq_2,
        void * f_eq_3, void * f_eq_4, void * f_eq_5,
        ...
        unsigned long blocksize)
{
    honei::cuda_collide_stream_grid<double>(start, end,
            dir_1, dir_2, dir_3, dir_4,
            dir_5, dir_6, dir_7, dir_8,
            f_eq_0, f_eq_1, f_eq_2,
            f_eq_3, f_eq_4, f_eq_5,
