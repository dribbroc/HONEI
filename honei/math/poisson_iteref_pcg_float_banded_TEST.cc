...
class PoissonTestIterefPCGBandedFloat:
    public BaseTest
{
    public:
        PoissonTestIterefPCGBandedFloat(const std::string & tag) :
            BaseTest("Poisson test for itrerative LES solvers , Iterative Refinement PCG (banded system)<" + tag + ">")
        {
        ...
        virtual void run() const
        {
            ...
            IterativeRefinement<methods::PCG::JAC, Tag_>::value(A, b_v, result, std::numeric_limits<float>::epsilon(), std::numeric_limits<float>::epsilon());
...
PoissonTestIterefPCGBandedFloat<tags::CPU, float> poisson_test_iteref_pcg_banded_float("float");
#ifdef HONEI_SSE
PoissonTestIterefPCGBandedFloat<tags::CPU::SSE, float> poisson_test_iteref_pcg_banded_float_sse("SSE float");
#endif
#ifdef HONEI_CELL
PoissonTestIterefPCGBandedFloat<tags::Cell, float> poisson_test_cg_banded_float_cell("Cell float");
#endif
