...
class PolyTestSparse:
    public BaseTest
{
    public:
        PolyTestSparse(const std::string & tag) :
            BaseTest("Poly test <" + tag + ">")
        {
        ...
        virtual void run() const
        {
            ...
            filename += "/honei/math/testdata/poisson_advanced4/sort_0/A_2.ell";
...
PolyTestSparse<tags::CPU, double> poly_test_sparse_ell_double("double");
