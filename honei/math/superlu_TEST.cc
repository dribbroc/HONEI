...
SuperLUTestSparseELL<tags::CPU, double> superlu_test_sparse_ell_double_2("double", "poisson_advanced4/sort_0/A_4.ell", "poisson_advanced4/sort_0/rhs_4", "poisson_advanced4/sort_0/sol_4");
