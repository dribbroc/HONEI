    ...
    public BaseTest
{
    public:
        ...
        virtual void run() const
        {
            ...
            IterativeRefinement<methods::PCG::JAC, Tag_>::value(A, b_v, result, std::numeric_limits<double>::epsilon(), std::numeric_limits<double>::epsilon());
...
#endif
#ifdef HONEI_CELL
PoissonTestIterefPCGDenseDouble<tags::Cell, double> poisson_test_iterefpcg_dense_double_cell("Cell double");
#endif
