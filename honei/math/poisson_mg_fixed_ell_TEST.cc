...
PoissonAdvancedTestMGSparseELLProlMatSpai<tags::GPU::CUDA, double> cuda_poisson_advanced_test_mg_sparse_prolmat_spai_double_2("double", 7ul, 0ul, "/honei/math/testdata/poisson_advanced/q2_sort_", 2);
#endif
#endif
