    ...
    public BaseTest
{
    public:
        ...
        virtual void run() const
        {
            ...
            ElementProduct<tags::CPU::SSE>::value(scaled_diag_inverted, diag_inverted);
...
#ifdef HONEI_SSE
PoissonTestJACKernelCascadeBandedFloat<tags::CPU::SSE, float> poisson_test_jac_banded_float("float");
#endif
