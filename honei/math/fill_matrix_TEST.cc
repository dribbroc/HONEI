...
FillMatrixTestDirichlet0<tags::CPU, double> fill_matrix_double_2("float", 25ul);
FillMatrixTestDirichlet0<tags::CPU, double> fill_matrix_double_3("float", 81ul);
FillMatrixTestDirichlet0<tags::CPU, double> fill_matrix_double_4("float", 289ul);
FillMatrixTestDirichlet0<tags::CPU, double> fill_matrix_double_5("float", 1089ul);
FillMatrixTestDirichlet0<tags::CPU, double> fill_matrix_double_6("float", 4225ul);
