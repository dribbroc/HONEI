                                ...
                                DenseMatrix<float> & height)
{
    ...
    float HONEI_ALIGNED(16) one_half(0.5f);
    m1 = _mm_set_ps1(one_half);


    float HONEI_ALIGNED(16) v_c_e[v.size()];
    float HONEI_ALIGNED(16) u_c_e[u.size()];
    float HONEI_ALIGNED(16) w_c_e[w.size()];
        ...
        DenseMatrix<double> & height)
{
    ...
    double HONEI_ALIGNED(16) v_c_e[v.size()];
    double HONEI_ALIGNED(16) u_c_e[u.size()];
    double HONEI_ALIGNED(16) w_c_e[w.size()];
