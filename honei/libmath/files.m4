...
add(`poisson_jac_float_banded',               `test')
add(`poisson_jackernel_float_banded_sse',     `test')
add(`poisson_jackernel_float_banded',         `test')
add(`poisson_jackernel_double_banded_sse',    `test')
add(`poisson_jackernel_double_banded',        `test')
add(`poisson_cg_float_banded',                `test')
add(`poisson_pcg_float_banded',               `test')
add(`poisson_iteref_cg_float_banded',         `test')
add(`poisson_iteref_pcg_float_banded',        `test')
