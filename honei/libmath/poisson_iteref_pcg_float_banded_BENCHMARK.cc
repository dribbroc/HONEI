...
class PoissonIteRefPCGBench :
    public Benchmark
{
    public:
        PoissonIteRefPCGBench(const std::string & id) :
            Benchmark(id)
        {
        ...
        virtual void run()
        {
            ...
            BENCHMARK((IterativeRefinement<PCG::JAC, Tag_>::value(A, b_v, std::numeric_limits<float>::epsilon(), std::numeric_limits<float>::epsilon())));
            evaluate();
        }
};
PoissonIteRefPCGBench<tags::CPU, float> poisson_irpcg_bench_float("Poisson IteRefPCG benchmark float CPU");
#ifdef HONEI_SSE
PoissonIteRefPCGBench<tags::CPU::SSE, float> poisson_irpcg_bench_float_sse("Poisson IteRefPCG benchmark float SSE");
#endif
#ifdef HONEI_CELL
PoissonIteRefPCGBench<tags::Cell, float> poisson_irpcg_bench_float_cell("Poisson IteRefPCG benchmark float Cell");
#endif
