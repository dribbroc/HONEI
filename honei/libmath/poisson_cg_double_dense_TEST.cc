...
class PoissonTestCGDenseDouble:
    public BaseTest
{
    public:
        PoissonTestCGDenseDouble(const std::string & tag) :
            BaseTest("Poisson test for itrerative LES solvers , CG (dense system)<" + tag + ">")
        {
...
#endif
#ifdef HONEI_CELL
PoissonTestCGDenseDouble<tags::Cell, double> poisson_test_cg_dense_double_cell("Cell, double");
#endif
