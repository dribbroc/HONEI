...
class PoissonTestJACKernelBandedDouble:
    public BaseTest
{
    public:
        PoissonTestJACKernelBandedDouble(const std::string & tag) :
...
PoissonTestJACKernelBandedDouble<tags::CPU, double> poisson_test_jac_banded_double("double");
