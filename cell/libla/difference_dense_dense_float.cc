...
namespace honei
{
    namespace cell
    {
        ...
        {
            void difference_dense_dense_float(vector float * a, const vector float * b,
        ...
        {
            Operation<2, float, rtm_dma> difference_dense_dense_float = {
                &implementation::difference_dense_dense_float
            };
        }
    }
}
