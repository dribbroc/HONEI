...
class IterativeRefinementTestDense:
    public BaseTest
{
    public:
        IterativeRefinementTestDense(const std::string & tag) :
...
IterativeRefinementTestDense<tags::CPU, double> iterref_test_double_dense("double");
