...
Enthält den Löser, der den gewünschte Bereich von u, h und v  beschrieben hat, beginnend bei 0.
...
Enthält den Löser, dem der Bereich von h\_index mitgeteilt werden muss, beginnend bei 0.
...
Enthält den Löser, dem der Bereich von f\_temp\_n mitgeteilt werden muss, beginnend bei 0.
...
Enthält den Löser, der den Bereich von f\_temp\_n beschrieben hat, beginnend bei 0.
