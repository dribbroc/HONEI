...
add(`matrix_element_inverse',    `hh', `test', `benchmark')
add(`matrix_elementwise_product',`hh', `test', `benchmark')
add(`matrix_element_sum',        `hh', `test')
add(`matrix_product',            `hh', `test', `benchmark')
add(`matrix_row_sum_vector',     `hh', `test', `benchmark')
add(`matrix_sum',                `hh', `test')
add(`matrix_vector_product',     `hh', `test')
add(`scalar_matrix_product',     `hh', `test', `benchmark')
add(`scalar_matrix_sum',         `hh', `test', `benchmark')
add(`scalar_product',            `hh', `cc', `test', `benchmark')
...
add(`vector_element_inverse',    `hh', `test')
add(`vector_elementwise_product',`hh', `test')
...
add(`vector_scaled_sum',         `hh', `test', `benchmark')
