...
PoissonJACKernelCascadeBench<tags::CPU, float, ONCE> poisson_jkc_bench_float_1("Poisson JACKernel benchmark ONCE");
PoissonJACKernelCascadeBench<tags::CPU, float, TWICE> poisson_jkc_bench_float_2("Poisson JACKernel benchmark TWICE(divide time by 2)");
