...
SMELLDenseVectorProductBench<tags::GPU::MultiCore::CUDA, float> mccudaSMELLDVPBenchfloat("CUDA SM 2 ELL Dense Vector Product Benchmark - matrix size: L2, float", 1025ul*1025, 10, "l2/area51_full_2.ell");
