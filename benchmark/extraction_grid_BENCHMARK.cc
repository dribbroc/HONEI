...
#ifdef HONEI_SSE
ExtractionGridBench<tags::CPU::SSE, float, lbm_modes::WET> wet_sse_extraction_grid_bench_float("WET SSE ExtractionGridBench - size: 2000, float", 2000, 10);
#endif
#ifdef HONEI_CUDA
ExtractionGridBench<tags::GPU::CUDA, float, lbm_modes::WET> wet_cuda_extraction_grid_bench_float("WET CUDA ExtractionGridBench - size: 2000, float", 2000, 10);
#endif
#ifdef HONEI_CELL
