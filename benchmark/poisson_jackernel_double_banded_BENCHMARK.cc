...
PoissonJACKernelBenchDouble<tags::CPU, double> poisson_jack_bench_double("Poisson JACKernel benchmark double CPU");
#ifdef HONEI_SSE
PoissonJACKernelBenchDouble<tags::CPU::SSE, double> poisson_jack_bench_double_sse("Poisson JACKernel benchmark double SSE");
#endif
/*#ifdef HONEI_CELL
PoissonJACKernelBenchDouble<tags::Cell, double> poisson_jack_bench_double_cell("Poisson JACKernel benchmark double Cell");
#endif*/
