    ...
    public Benchmark
{
    private:
        ...
        int _parts;
    public:
        GridPartitionerBench(const std::string & id, unsigned long size, int count, int parts) :
            Benchmark(id)
        {
...
GridPartitionerBench<tags::CPU, float> partitioner_bench_float_1("LBM Grid partitioner synch Benchmark - size: 500x500, float, 250 parts", 500, 25, 250);
GridPartitionerBench<tags::CPU, double> partitioner_bench_double_1("LBM Grid partitioner synch Benchmark - size: 500x500, double, 250 parts", 500, 25, 250);
