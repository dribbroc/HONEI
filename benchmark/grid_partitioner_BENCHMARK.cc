...
GridPartitionerDecomposeBench<tags::CPU, float> partitioner_decompose_bench_float_1("LBM Grid partitioner decompose Benchmark - size: 500x500, float, 25 parts", 500, 25, 25);
GridPartitionerDecomposeBench<tags::CPU, double> partitioner_decompose_bench_double_1("LBM Grid partitioner decompose Benchmark - size: 500x500, double, 25 parts", 500, 25, 25);
