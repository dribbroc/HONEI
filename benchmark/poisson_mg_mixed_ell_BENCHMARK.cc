...
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_7_0_q1("PARENG MG double cuda L7, q1 sort 0", 7ul, 0ul, "/honei/math/testdata/poisson_advanced/sort_", 0);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_8_0_q1("PARENG MG double cuda L8, q1 sort 0", 8ul, 0ul, "/honei/math/testdata/poisson_advanced/sort_", 0);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_9_0_q1("PARENG MG double cuda L9, q1 sort 0", 9ul, 0ul, "/honei/math/testdata/poisson_advanced/sort_", 0);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_10_0_q1("PARENG MG double cuda L10, q1 sort 0", 10ul, 0ul, "/honei/math/testdata/poisson_advanced/sort_", 0);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_6_0_q2("PARENG MG double cuda L6, q2 sort 0", 6ul, 0ul, "/honei/math/testdata/poisson_advanced/q2_sort_", 2);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_7_0_q2("PARENG MG double cuda L7, q2 sort 0", 7ul, 0ul, "/honei/math/testdata/poisson_advanced/q2_sort_", 2);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_8_0_q2("PARENG MG double cuda L8, q2 sort 0", 8ul, 0ul, "/honei/math/testdata/poisson_advanced/q2_sort_", 2);
PoissonAdvancedBENCHMGSparseELLProlMat<tags::GPU::CUDA, tags::CPU::MultiCore::SSE, double> cuda_poisson_advanced_bench_mg_sparse_prolmat_double_9_0_q2("PARENG MG double cuda L9, q2 sort 0", 9ul, 0ul, "/honei/math/testdata/poisson_advanced/q2_sort_", 2);
#endif
#endif
#endif
