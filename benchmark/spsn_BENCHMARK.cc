...
#endif
#ifdef HONEI_CELL
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_m4("Cell SPSN   Benchmark - vector size: 289, float", 289ul, 10);
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_m3("Cell SPSN   Benchmark - vector size: 1089, float", 1089ul, 10);
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_m2("Cell SPSN   Benchmark - vector size: 4225, float", 4225ul, 10);
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_m1("Cell SPSN   Benchmark - vector size: 16641, float", 16641ul, 10);
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_0("Cell SPSN Benchmark - vector size: 66049, float", 66049ul, 10);
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_1("Cell SPSN Benchmark - vector size: 263169, float", 263169ul, 10);
SPSNBench_TUTORIAL<tags::Cell, float> spsn_tut_float_cell_2("Cell SPSN Benchmark - vector size: 1050625, float", 1050625ul, 10);
#endif
